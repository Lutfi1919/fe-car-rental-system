                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-2xl" data-aos="fade-in">
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className='p-10 flex flex-col justify-center' style={{fontFamily: "Stack Sans Headline"}}>
                            <p className='text-3xl mb-3'>Create an Account</p>
                            <p className='text-gray-400 font-satoshi font-medium'>Welcome to <span className='italic' style={{fontFamily: "Anton"}}>InstaDrive</span> - Let's Get Started</p>
                            <hr className='text-gray-200 border-t-2 my-10'/>
                            <form>
                                <div className="mb-4">
                                    <label className="block text-black text-sm font-bold mb-2" for="name">Your name</label>
                                ...
                                <div className="mb-4">
                                    <label className="block text-black text-sm font-bold mb-2" for="password">Create new password</label>
                                ...
                                <button type='submit' className="w-full bg-black text-white py-2 px-4 rounded-lg hover:bg-black/75 transition-all duration-150 cursor-pointer">Create new account</button>
                            </form>
                            <div className="flex items-center justify-center mt-3">
                                <p className='text-center text-sm text-gray-400'>Already have an account?</p>
